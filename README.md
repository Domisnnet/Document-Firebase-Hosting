...
📘 Deploy de Angular no Firebase HostingDocumentação técnica premium para publicar uma aplicação Angular no Firebase Hosting.
...
Abaixo está o conteúdo **revisado e padronizado em Markdown**, pronto para salvar como `README.md`.

> **Importante:** o conteúdo começa diretamente com `#` e não está envolvido por outro bloco de código. Isso evita que os blocos internos `bash`, `json`, `text` e `powershell` sejam quebrados no GitHub.
